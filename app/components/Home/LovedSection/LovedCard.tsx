...
export default function LovedCard({
  ...
  return (
    ...
    >
      <div className="relative h-[400px] w-full overflow-visible rounded-[2px] bg-[#141414] sm:h-[460px] md:h-[450px] lg:h-[380px] xl:h-[420px]">
        ...
        <div className="absolute right-4 top-5 z-30 flex flex-col gap-3 sm:right-5 sm:top-6 lg:right-6 lg:gap-4">
          ...
          <ActionIcon label="add-to-cart" onClick={onAddToCart}>
            <svg viewBox="0 0 24 24" aria-hidden className="h-[18px] w-[18px]">
              <path
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 px-4 pb-5 sm:px-5 sm:pb-6 lg:px-7 lg:pb-7">
          <div className="flex min-h-[210px] flex-col justify-end">
            ...
            <div className="min-w-0">
              <h3 className="text-[22px] font-semibold leading-[1.05] tracking-[0.04em] text-white sm:text-[26px] md:text-[30px] lg:text-[10px] xl:text-[18px] 2xl:text-[22px]">
                {product.title}
              </h3>

              <p className="mt-4 text-[13px] leading-[1.35] text-white/60 sm:text-[14px] md:text-[15px] lg:text-[10px] xl:text-[14px]">
                {product.subtitle}
              </p>
            </div>
            ...
            <div className="mt-7 flex items-end justify-between gap-4">
              ...
              <motion.button
                ...
                onClick={onAddToCart}
                className={`inline-flex h-[52px] min-w-[136px] items-center justify-center rounded-full px-8 text-[18px] font-semibold tracking-[0.02em] transition-all duration-300 lg:min-w-[146px] ${
                  isActive
